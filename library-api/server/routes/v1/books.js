...
import createAuthorizer from '../../middleware/request_authorizer.js'
import authenticator from '../../middleware/request_authentificator.js'
...
router.post('/books',createAuthorizer("librarian"),authenticator, async (req, res, next) => {
  try {
...
router.put('/books/:id',createAuthorizer("librarian"),authenticator, async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
    const title = req.body.title
    const author = req.body.author
...
router.patch('/books/:id',createAuthorizer("librarian"),authenticator, async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
    const title = req.body.title
    const author = req.body.author
...
router.delete('/books/:id',createAuthorizer("librarian"),authenticator, async (req, res, next) => {
  try {
    const id = Number.parseInt(req.params.id)
